...
url <- "https://www.dropbox.com/s/fnb0zzlm11sglf1/Suppl.data%20-%20analysis.xlsx?dl=1"
...
url <- "https://www.dropbox.com/s/isl22k7nxhcwy4u/Suppl.data%20-%20clinical%20parameters.xlsx?dl=1"
GET(url, write_disk(tf <- tempfile(fileext = ".xlsx")))
...
url <- "https://www.dropbox.com/s/cdpy1mqd45edrm9/cfDNA_HMW_ratio.xlsx?dl=1"
GET(url, write_disk(tf <- tempfile(fileext = ".xlsx")))
HMW_ratio <-  read_excel(tf, sheet = "Sheet1", skip = 0, col_names = TRUE )
